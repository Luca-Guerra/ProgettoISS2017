%==============================================
% WorldTheory.pl for actor console
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuconsole).	%%old version (deprecated)
actorobj(qatuconsole).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor console
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of console" ). 
...
%-------------------------------------------------
%  User static rules about console
%------------------------------------------------- 
value( area_a_angle,60).
value( area_a_dist,60).
value( area_b_angle,160).
